...
To distinguish MandiIQ from typical data dashboards, we upgraded the frontend styling, adapting a stark, immersive monochrome aesthetic with lime accent highlights:
